            ...
            <nav>
                <ul id="navmenu-h">
                    ...
                    <li>
                       ...
                       <!-- <ul>
                            <li><a href="<?php echo U("Index/Veterinary/index");?>">医师团队</a></li>
                            <li><a href="<?php echo U("Index/Department/index");?>">服务项目</a></li>
                            <li><a href="<?php echo U("Index/Disease/index");?>">病例分享</a></li>
                        </ul>-->
			...
			<div class="blog_lft lft">
				...
				<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="post_main lft">
						...
						<div class="post_cont lft">
							<img src="Public/Uploads/<?php echo ($vo["img"]); ?>" width="100%" alt="">
							姓名：<?php echo ($vo['title']); ?><br><span>编号：<?php echo ($vo['num']); ?></span>
								<!--<br><span>专业：<?php echo ($vo['major']); ?></span>-->
							<br>
							介绍：
