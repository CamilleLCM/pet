			...
			<div class="blog_rgt rgt">
				<div class="rgt_box lft">
					<div class="search lft">
						<form method="post" id="form1" action="<?php echo U('Index/Department/index');?>">
				...
				<div class="rgt_box abouttxt lft">
						...
						<div class="clear"></div>
					<h4><p>如果你想添加宠物认领请单击：</p></h4>
					<li class="last lft"><input type="submit" onclick="window.location.href='<?php echo U("Index/Department/add");?>'" value="添加" class="submit_btn" /></li>
				</div>
