...
<!-- left menu ends -->
        <div class="span9">
            <h1 class="page-title">添加知道或趣事</h1>
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#" data-toggle="tab">添加</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
    <form id="subform" enctype="multipart/form-data" action="<?php echo U('Admin/Message/add_do');?>" method="post">
        <label>标题：</label>
        ...
        <label>具体描述：</label>
        <textarea style="margin: 0px 0px 10px; width: 653px; height: 107px;" name="content"></textarea>

       <label></label>
      <button class="btn btn-primary" onclick="document.getElementById('subform').submit();return false"><i class="icon-save"></i> 添加</button>
    </form>
      </div>
  </div>
