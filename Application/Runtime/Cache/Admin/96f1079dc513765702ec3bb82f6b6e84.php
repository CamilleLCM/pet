...
<!-- left menu ends -->
        <div class="span9">
            <h1 class="page-title">Banner图列表</h1>
<div class="btn-toolbar">
    <button class="btn btn-primary" onclick="window.location.href='<?php echo U("Admin/Banner/add");?>'"><i class="icon-plus"></i>
	添加Banner图 </button>
  <div class="btn-group">
  </div>
</div>
    ...
    <table class="table">
      ...
      <tbody>
        <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
				...
				<td>
		              <a href="<?php echo U('Admin/Banner/edit',array('id'=>$vo['id']));?>"><i class="icon-pencil"></i></a>
		              <a href="<?php echo U('Admin/Banner/del_by_id',array('id'=>$vo['id']));?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
	            </td>
