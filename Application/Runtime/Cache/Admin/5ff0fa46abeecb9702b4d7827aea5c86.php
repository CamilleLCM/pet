            ...
            <div class="well">
                <table class="table">
                    ...
                    <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
                            ...
                            <td class="center" width="100px"><?php echo ($vo['content']); ?></td>
                            <td class="center"><?php echo (date("Y-m-d H:i:s",$vo['ctime'])); ?></td>

                            <td>
                                <a href="<?php echo U('Admin/Yijian/del_by_id',array('id'=>$vo['id']));?>"><i class="icon-remove"></i></a>
                            </td>
