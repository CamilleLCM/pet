...
<!-- left menu ends -->
        <div class="span9">
            <h1 class="page-title">知道和趣事列表</h1>
<div class="btn-toolbar">
    <button class="btn btn-primary" onclick="window.location.href='<?php echo U("Admin/Message/add");?>'"><i class="icon-plus"></i>
	添加信息 </button>
  <div class="btn-group">
  </div>
</div>
      ...
      <tbody>
        <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
            ...
            <td class="center">
                ...
                <td class="center"><?php echo ($vo['fenlei']); ?></td>

				<td>
		              <a href="<?php echo U('Admin/Message/edit',array('id'=>$vo['id']));?>"><i class="icon-pencil"></i></a>
		              <a onClick="return confirm('确认要删除？')" href="<?php echo U('Admin/Message/del_by_id',array('id'=>$vo['id']));?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
	            </td>
