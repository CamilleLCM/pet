...
<!-- left menu ends -->
        <div class="span9">
            <h1 class="page-title">宠物课堂列表</h1>
<div class="btn-toolbar">
    <button class="btn btn-primary" onclick="window.location.href='<?php echo U("Admin/Pet/add");?>'"><i class="icon-plus"></i>
	添加宠物 </button>
  <div class="btn-group">
  </div>
</div>
    ...
    <table class="table">
      <thead>
        <tr>
            <th width="80">宠物图片</th>
			 <th width="80">宠物名称</th>
	         <th width="80">宠物外形特征</th>
	         <th width="80">宠物饲养方法</th>
			 <th width="80">添加时间</th>
		     <th width="80">操作</th>
	  </tr>
      </thead>
      <tbody>
        <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
            ...
            <td class="center">
                ...
                <td class="center"><?php echo (msubstr($vo['num'],0,50)); ?></td>
                <td class="center"><?php echo (msubstr($vo['content'],0,50)); ?></td>
            <td class="center"><?php echo (date("Y-m-d H:i:s",$vo['ctime'])); ?></td>

            <td>
                <a href="<?php echo U('Admin/Pet/edit',array('id'=>$vo['id']));?>"><i class="icon-pencil"></i></a>
                <a onClick="return confirm('确认要删除？')" href="<?php echo U('Admin/Pet/del_by_id',array('id'=>$vo['id']));?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
            </td>
            ...
            <div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-header">
                    ...
                    <h3 id="myModalLabel">Delete Confirmation</h3>5
    </div>
