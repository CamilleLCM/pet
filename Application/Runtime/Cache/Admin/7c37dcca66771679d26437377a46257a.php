...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
          <form id="subform" enctype="multipart/form-data" action="<?php echo U('Admin/Pet/edit_do',array('id'=>$result['id']));?>" method="post">
              <label>名称：</label>
              ...
              <label>宠物外形特征：</label>
              <textarea style="margin: 0px 0px 10px; width: 672px; height: 152px;" name='num' ><?php echo ($result['num']); ?></textarea>
              <label>宠物饲养方法：</label>
