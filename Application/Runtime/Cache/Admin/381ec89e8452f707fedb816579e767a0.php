...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
          <form id="subform" enctype="multipart/form-data" action="<?php echo U('Admin/Comment/edit_do',array('id'=>$result['id']));?>" method="post">
              <label>标题：<?php echo ($result["message"]["title"]); ?></label>

              <label>评论人：<?php echo ($result["user"]["name"]); ?></label>
