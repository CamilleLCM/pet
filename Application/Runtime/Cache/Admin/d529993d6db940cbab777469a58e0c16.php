...
<div class="well">
    ...
    <form id="subform" enctype="multipart/form-data" action="<?php echo U('Admin/Pet/add_do');?>" method="post">
        <label>宠物名称：</label>
        ...
        <label>宠物外形特征：</label>
        <textarea style="margin: 0px 0px 10px; width: 672px; height: 152px;" type="text" value="" name='num' ></textarea>
         <label>宠物饲养方法：</label>
        <textarea style="margin: 0px 0px 10px; width: 672px; height: 152px;" name="content"  ><?php echo ($result['content']); ?></textarea>
