...
<div class="btn-toolbar">
    <button class="btn btn-primary" onclick="window.location.href='<?php echo U("Admin/Veterinary/add");?>'"><i class="icon-plus"></i>
	添加管理员 </button>
  <div class="btn-group">
  </div>
</div>
    ...
    <table class="table">
      ...
      <tbody>
        <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
                ...
                <td class="center"><?php echo ($vo['major']); ?></td>
				<td class="center"><?php echo (date("Y-m-d H:i:s",$vo['ctime'])); ?></td>

				<td>
		              <a href="<?php echo U('Admin/Veterinary/edit',array('id'=>$vo['id']));?>"><i class="icon-pencil"></i></a>
		              <a onClick="return confirm('确认要删除？')" href="<?php echo U('Admin/Veterinary/del_by_id',array('id'=>$vo['id']));?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
	            </td>
