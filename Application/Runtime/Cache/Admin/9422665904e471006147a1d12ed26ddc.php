            ...
            <div class="well">
                <table class="table">
                    ...
                    <?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr>
                            <td class="center"><?php echo ($vo['message']['title']); ?></td>
                            <td class="center"><?php echo ($vo['user']['name']); ?></td>
                            <td class="center">
                                <img alt="" width="80" src="Public/Uploads/<?php echo ($vo["user"]["img"]); ?>">
                            </td>
                            <td class="center" width="100px"><?php echo (msubstr($vo['content'],0,50)); ?></td>
                            <td class="center"><?php echo (date("Y-m-d H:i:s",$vo['ctime'])); ?></td>
                            <td>
                                <a href="<?php echo U('Admin/Comment/edit',array('id'=>$vo['id']));?>"><i class="icon-pencil"></i></a>
                                <a onClick="return confirm('确认要删除？')" href="<?php echo U('Admin/Comment/del_by_id',array('id'=>$vo['id']));?>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
                            </td>
