...
<!-- left menu ends -->
        <div class="span9">
            <h1 class="page-title">修改Banner图</h1>
...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
          <form id="subform" enctype="multipart/form-data" action="<?php echo U('Admin/Banner/edit_do',array('id'=>$result['id']));?>" method="post">
              <label>名称：</label>
              ...
              <label>链接：</label>
              <input type="text" value="<?php echo ($result['href']); ?>" name='href' />
