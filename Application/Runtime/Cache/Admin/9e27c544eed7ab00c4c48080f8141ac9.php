            ...
            <div class="well">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        ...
                        <label style="font-size: 20px">宠物照片：</label>
                        <img alt="" width="200" src="Public/Uploads/<?php echo ($result["img"]); ?>">
                        </br></br>
                        <label style="font-size: 20px">内容：</label>
                        <label style="font-size: 15px;"><?php echo ($result['content']); ?></label>
                        <label></label>
                        </br>
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        <button class="btn btn-primary" onclick="window.location.href='<?php echo U('Admin/Department/examine_do',array('id'=>$result['id']));?>'">
                            <i class="icon-save"></i> 通过审核</button>&emsp;
                        <button class="btn btn-danger" onclick="window.location.href='<?php echo U('Admin/Department/examine_do',array('id'=>$result['id'],'type'=>'no'));?>'">
